...
public abstract class BooleanExp {
	...
	abstract public boolean evaluate(Context context); // evaluates this boolean expression
	@Override
	public String toString() {
		return this.printPreorder();
	}
	abstract public String printPreorder(); // prints this boolean expression in preorder
	abstract public String printInorder(); // prints this boolean expression in inorder
